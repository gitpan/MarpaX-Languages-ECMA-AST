...
package MarpaX::Languages::ECMA::AST::Impl;

# ABSTRACT: Implementation of Marpa's interface

use Marpa::R2 2.073;
use Carp qw/croak/;
use MarpaX::Languages::ECMA::AST::Impl::Logger;
...
sub BEGIN {
    ...
    if (! defined($MARPA_TRACE_FILE_HANDLE)) {
      ...
      if (! tie ${$MARPA_TRACE_FILE_HANDLE}, 'MarpaX::Languages::ECMA::AST::Impl::Logger') {
...
MarpaX::Languages::ECMA::AST::Impl - Implementation of Marpa's interface
...
=head1 SYNOPSIS
    ...
    use strict;
    use warnings FATAL => 'all';
    use MarpaX::Languages::ECMA::AST::Impl;

    my $marpaImpl = MarpaX::Languages::ECMA::AST::Impl->new();
