...
package MarpaX::Languages::ECMA::AST::Util;

# ABSTRACT: ECMA Translation to AST - Class method utilities
...
sub traceAndUnpack {
    ...
    #
    # Skip MarpaX::Languages::ECMA::AST::if any
    #
    $whowasi =~ s/^MarpaX::Languages::ECMA::AST:://;
...
MarpaX::Languages::ECMA::AST::Util - ECMA Translation to AST - Class method utilities
